            ...
            <div className="bg-white/30 p-12 shadow-xl ring-1 ring-gray-900/5 rounded-lg backdrop-blur-lg max-w-xl mx-auto w-full mt-40 mb-10">
                <div className="flex justify-between items-center">
                    <h1 className='max-w-xl font-semibold text-xl tracking-tighter text-gray-200 hover:text-white'>
                        A simple user manager using Next.js, TypeScript, and Tailwind CSS for the frontend, with Node.js, Express.js, and PostgreSQL for the backend, all composed using Docker.
                    </h1>
                </div>
            </div>
            <Link
                href="https://github.com/rwsaamanen/Full-Stack-Docker-App"
